...
/*jshint forin:true, noarg:true, noempty:true, eqeqeq:true, bitwise:true, 
 s tri*ct:true, undef:true, curly:true, browser:true, node:true, 
...
var WSE = (function (Squiddle, MO5, STEINBECK)
{
    ...
    out.Interpreter.prototype.runCommand = function (command)
    {
        ...
        assetName !== null && assetName in this.assets && typeof this.assets[assetName][tagName] === "function" && tagName.match(/(show|hide|clear|flicker|flash|play|start|stop|pause|move|set)/))
        {
    ...
    {
        interpreter.bus.trigger("wse.interpreter.commands.break",
        {
    ...
    out.Interpreter.prototype.commands.trigger = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.trigger",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands.sub = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.sub",
        {
            interpreter: interpreter,
            command: command
        }, false);
        ...
        interpreter.bus.trigger("wse.interpreter.message", "Entering sub scene '" + sceneId + "'...",
        false);
    ...
    out.Interpreter.prototype.commands["var"] = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.var",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands.wait = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.wait",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands.choice = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.choice",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands.goto = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.goto",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands.line = function (command, interpreter)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.line",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.commands["do"] = function (command, interpreter, args)
    {
        ...
        interpreter.bus.trigger("wse.interpreter.commands.do",
        {
            interpreter: interpreter,
            command: command
        }, false);
    ...
    out.Interpreter.prototype.toggleSavegameMenu = function ()
    {
        ...
        for (i = 0, len = savegames.length; i < len; i += 1)
        {
            ...
            curEl.innerHTML = '' + '<p class="name">' + cur.name + '</p>' + '<p class="description">' + '<span class="elapsed">' + parseInt((curElapsed / 60) / 60, 10) + 'h ' + parseInt((curElapsed / 60) % 60, 10) + 'm ' + parseInt(curElapsed % 60, 10) + 's' + '</span>' + '<span class="date">' + new Date(cur.saveTime * 1000).toUTCString() + '</span>' + '</p>';
